...
package ora.pt.cons.igif.services.proxy.estadoprocesso.runtime;
...
import ora.pt.cons.igif.services.proxy.estadoprocesso.AttributedURI;

import org.w3c.dom.Document;

public class SaudeCCRespostaConsultaEstadoProcessoPortBinding_Stub extends oracle.j2ee.ws.client.StubBase implements ora.pt.cons.igif.services.proxy.estadoprocesso.SaudeCCRespostaConsultaEstadoProcessoType {
    ...
    public SaudeCCRespostaConsultaEstadoProcessoPortBinding_Stub(HandlerChain handlerChain) {
        super(handlerChain);
        ...
        setServiceName(new QName("http://dynamicgateway.fsc.pt.gov.interop/", 
                                 "SaudeCCRespostaConsultaEstadoProcessoService"));
        setPortName(new QName("http://dynamicgateway.fsc.pt.gov.interop/", 
                              "SaudeCCRespostaConsultaEstadoProcessoPort"));
        setupConfig("ora/pt/cons/igif/services/proxy/estadoprocesso/runtime/SaudeCCRespostaConsultaEstadoProcessoPortBinding_Stub.xml");
    }

    /*
     *  implementation of saudeCCRespostaConsultaEstadoProcesso
     */

     public void saudeCCRespostaConsultaEstadoProcesso(javax.xml.soap.SOAPElement saudeCCRespostaConsultaEstadoProcessoParameters)
          {
         ...
         try {
             ...
             Object o = null;
             i = saudeCCRespostaConsultaEstadoProcessoParameters.getParentElement().getParentElement().getChildElements();
             while(i.hasNext()){
                o = i.next();     
             ...
             try{            
                 Document d = saudeCCRespostaConsultaEstadoProcessoParameters.getOwnerDocument();
             ...
             _request.setOperationCode(SaudeCCRespostaConsultaEstadoProcesso_OPCODE);
             _state.getMessageContext().setProperty("oracle.j2ee.ws.mgmt.interceptor.operation-qname",new QName("","SaudeCCRespostaConsultaEstadoProcesso"));
             ...
             SOAPBlockInfo _bodyBlock = new SOAPBlockInfo(ns1_SaudeCCRespostaConsultaEstadoProcesso_SaudeCCRespostaConsultaEstadoProcesso_QNAME);
             _bodyBlock.setValue(saudeCCRespostaConsultaEstadoProcessoParameters);
             _bodyBlock.setSerializer(ns1_SaudeCCRespostaConsultaEstadoProcesso_TYPE_QNAMEjavax$2e$xml$2e$soap$2e$SOAPElement_Serializer);
             _request.setBody(_bodyBlock);

             _state.getMessageContext().setProperty("http.soap.action", "http://dynamicgateway.fsc.pt.gov.interop/SaudeCCRespostaConsultaEstadoProcesso");
             try {
                 //BufferedWriter bw = new BufferedWriter(new FileWriter(new File("c:\\proxy_estad.log"),true));
                 BufferedWriter bw = new BufferedWriter(new FileWriter(new File("/oracle/product/10.1.3.1/proxy_estad.log"),true));
                 bw.newLine();
                 bw.write("<-- -->");
                 bw.newLine();
             ...
             // let this one through unchanged, one-way operation
              try {
                              BufferedWriter bw = new BufferedWriter(new FileWriter(new File("/oracle/product/10.1.3.1/proxy_estad.err"),true));
                              //BufferedWriter bw = new BufferedWriter(new FileWriter(new File("c:\\proxy_estad.err"),true));
                              bw.newLine();
    ...
    public void _initialize(InternalTypeMappingRegistry registry) throws Exception {
        ...
        ns1_SaudeCCRespostaConsultaEstadoProcesso_TYPE_QNAMEjavax$2e$xml$2e$soap$2e$SOAPElement_Serializer = 
                (CombinedSerializer)registry.getSerializer("", 
                                                           javax.xml.soap.SOAPElement.class, 
                                                           ns1_SaudeCCRespostaConsultaEstadoProcesso_TYPE_QNAME);
    ...
    private static final QName _portName = 
        new QName("http://dynamicgateway.fsc.pt.gov.interop/", 
                  "SaudeCCRespostaConsultaEstadoProcessoPort");
    private static final int SaudeCCRespostaConsultaEstadoProcesso_OPCODE = 0;
    private static final QName ns1_SaudeCCRespostaConsultaEstadoProcesso_SaudeCCRespostaConsultaEstadoProcesso_QNAME = 
        new QName("http://www.min-saude.pt/schemas/CartaoCidadao/2007/05", 
                  "SaudeCCRespostaConsultaEstadoProcesso");
    private static final QName ns1_SaudeCCRespostaConsultaEstadoProcesso_TYPE_QNAME = 
        new QName("http://www.min-saude.pt/schemas/CartaoCidadao/2007/05", 
                  "SaudeCCRespostaConsultaEstadoProcesso");
    private CombinedSerializer ns1_SaudeCCRespostaConsultaEstadoProcesso_TYPE_QNAMEjavax$2e$xml$2e$soap$2e$SOAPElement_Serializer;
