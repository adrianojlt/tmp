...
import ora.pt.cons.igif.services.proxy.identificacao.SaudeCCRespostaIdentificarCidadaoPortClient;
...
public class SaudeCCRespostaIdentificarCidadaoProxyTypeImpl {
    public SOAPElement saudeCCRespostaIdentificarCidadaoProxy(SOAPElement saudeCCRespostaIdentificarCidadaoProxyParameters) {
        SaudeCCRespostaIdentificarCidadaoPortClient proxy = null;
        ...
        try{
            ...
            Object o = null;
            i = saudeCCRespostaIdentificarCidadaoProxyParameters.getParentElement().getParentElement().getChildElements();
            while(i.hasNext()){
                o = i.next();     
            ...
            Document d = saudeCCRespostaIdentificarCidadaoProxyParameters.getOwnerDocument();
            
            StringWriter stringWriter = new StringWriter();
            ((XMLElement) d.getDocumentElement()).print(stringWriter);            
            String s = stringWriter.toString();
            
            bw = new BufferedWriter(new FileWriter(new File("/oracle/product/10.1.3.1/identificacaowsa.log"),true));
         ...
         //   }
            ...
            ///// FIM
            s = s.replaceAll("SaudeCCRespostaIdentificarCidadaoProxy","SaudeCCRespostaIdentificarCidadao");
            //System.out.println(s);
            s = s.substring(s.indexOf("<SaudeCCRespostaIdentificarCidadao"),s.indexOf("</SaudeCCRespostaIdentificarCidadao>") + "</SaudeCCRespostaIdentificarCidadao>".length());
            //s = s.substring(s.indexOf("<cc:SaudeCCRespostaIdentificarCidadao"),s.indexOf("</cc:SaudeCCRespostaIdentificarCidadao>") + "</cc:SaudeCCRespostaIdentificarCidadao>".length());
            ...
            proxy = new SaudeCCRespostaIdentificarCidadaoPortClient();
            proxy.saudeCCRespostaIdentificarCidadao(ss);
            retValString = "OK";
