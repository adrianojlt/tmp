...
public class SaudeCCRenovacaoRespostaIdentificarCidadaoPortBinding_Stub
    extends oracle.j2ee.ws.client.StubBase
    implements ora.pt.cons.igif.services.proxy.renovacao.SaudeCCRenovacaoRespostaIdentificarCidadaoType {
    
    
    /*
     *  public constructor
     */
    public SaudeCCRenovacaoRespostaIdentificarCidadaoPortBinding_Stub(HandlerChain handlerChain) {
        super(handlerChain);
        _setProperty(ENDPOINT_ADDRESS_PROPERTY, "http://toolkitsaude_testes:80/Saude/");
        //_setProperty(ENDPOINT_ADDRESS_PROPERTY, "http://toolkitsaude:80/gw/dynamicgateway/SaudeCCRenovacaoRespostaIdentificarCidadao");
        setSoapVersion(SOAPVersion.SOAP_11);
        setServiceName( new QName("http://dynamicgateway.fsc.pt.gov.interop/","SaudeCCRenovacaoRespostaIdentificarCidadaoService"));
        setPortName( new QName("http://dynamicgateway.fsc.pt.gov.interop/","SaudeCCRenovacaoRespostaIdentificarCidadaoPort"));
        setupConfig("ora/pt/cons/igif/services/proxy/renovacao/runtime/SaudeCCRenovacaoRespostaIdentificarCidadaoPortBinding_Stub.xml");
    }
    
    /*
     *  implementation of saudeCCRenovacaoRespostaIdentificarCidadao
     */
    public void saudeCCRenovacaoRespostaIdentificarCidadao(javax.xml.soap.SOAPElement saudeCCRenovacaoRespostaIdentificarCidadaoParameters)
         {
        ...
        try {
            ...
            Object o = null;
            i = saudeCCRenovacaoRespostaIdentificarCidadaoParameters.getParentElement().getParentElement().getChildElements();
            while(i.hasNext()){
               o = i.next();     
            ...
            try{            
                Document d = saudeCCRenovacaoRespostaIdentificarCidadaoParameters.getOwnerDocument();
            ...
            _request.setOperationCode(SaudeCCRenovacaoRespostaIdentificarCidadao_OPCODE);
            _state.getMessageContext().setProperty("oracle.j2ee.ws.mgmt.interceptor.operation-qname",new QName("","SaudeCCRenovacaoRespostaIdentificarCidadao"));
            ...
            SOAPBlockInfo _bodyBlock = new SOAPBlockInfo(ns1_SaudeCCRenovacaoRespostaIdentificarCidadao_SaudeCCRenovacaoRespostaIdentificarCidadao_QNAME);
            _bodyBlock.setValue(saudeCCRenovacaoRespostaIdentificarCidadaoParameters);
            _bodyBlock.setSerializer(ns1_SaudeCCRenovacaoRespostaIdentificarCidadao_TYPE_QNAMEjavax$2e$xml$2e$soap$2e$SOAPElement_Serializer);
            _request.setBody(_bodyBlock);
            
            _state.getMessageContext().setProperty("http.soap.action", "http://dynamicgateway.fsc.pt.gov.interop/SaudeCCRenovacaoRespostaIdentificarCidadao");
            
            try {
                //BufferedWriter bw = new BufferedWriter(new FileWriter(new File("c:\\proxy_renov.log"),true));
                BufferedWriter bw = new BufferedWriter(new FileWriter(new File("/oracle/product/10.1.3.1/proxy_renov.log"),true));
                bw.newLine();
                bw.write("<-- -->");
                bw.newLine();
            ...
            // let this one through unchanged, one-way operation
             try {
                 BufferedWriter bw = new BufferedWriter(new FileWriter(new File("/oracle/product/10.1.3.1/proxy_renov.err"),true));
                 //BufferedWriter bw = new BufferedWriter(new FileWriter(new File("c:\\proxy_renov.err"),true));
                 bw.newLine();
    ...
    public void _initialize(InternalTypeMappingRegistry registry) throws Exception {
        ...
        ns1_SaudeCCRenovacaoRespostaIdentificarCidadao_TYPE_QNAMEjavax$2e$xml$2e$soap$2e$SOAPElement_Serializer = (CombinedSerializer)registry.getSerializer("", javax.xml.soap.SOAPElement.class, ns1_SaudeCCRenovacaoRespostaIdentificarCidadao_TYPE_QNAME);
    ...
    private static final QName _portName = new QName("http://dynamicgateway.fsc.pt.gov.interop/", "SaudeCCRenovacaoRespostaIdentificarCidadaoPort");
    private static final int SaudeCCRenovacaoRespostaIdentificarCidadao_OPCODE = 0;
    private static final QName ns1_SaudeCCRenovacaoRespostaIdentificarCidadao_SaudeCCRenovacaoRespostaIdentificarCidadao_QNAME = new QName("http://www.min-saude.pt/schemas/CartaoCidadao/2007/05", "SaudeCCRenovacaoRespostaIdentificarCidadao");
    private static final QName ns1_SaudeCCRenovacaoRespostaIdentificarCidadao_TYPE_QNAME = new QName("http://www.min-saude.pt/schemas/CartaoCidadao/2007/05", "SaudeCCRenovacaoRespostaIdentificarCidadao");
    private CombinedSerializer ns1_SaudeCCRenovacaoRespostaIdentificarCidadao_TYPE_QNAMEjavax$2e$xml$2e$soap$2e$SOAPElement_Serializer;
    ...
    private static final String[] myNamespace_declarations =
                                        new String[] {
                                            "ns0", "http://www.min-saude.pt/schemas/CartaoCidadao/2007/05",
