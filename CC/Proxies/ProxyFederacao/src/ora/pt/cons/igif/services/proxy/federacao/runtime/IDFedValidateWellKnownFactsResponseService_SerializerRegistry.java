...
import ora.pt.cons.igif.services.proxy.federacao.AttributedURI_LiteralSerializer;

public class IDFedValidateWellKnownFactsResponseService_SerializerRegistry extends SerializerRegistryBase implements SerializerConstants {
    public IDFedValidateWellKnownFactsResponseService_SerializerRegistry() {
    }
    ...
    public TypeMappingRegistry getRegistry() {
        ...
        {
            QName type = new QName("http://www.interop.gov.pt/schemas/FedId/2010/01", "IDFedValidateWellKnownFactsResponse");
        ...
        ora.pt.cons.igif.services.proxy.federacao.runtime.IDFedValidateWellKnownFactsResponseService_SerializerRegistry12 internal12Registry = new ora.pt.cons.igif.services.proxy.federacao.runtime.IDFedValidateWellKnownFactsResponseService_SerializerRegistry12();
