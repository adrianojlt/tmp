 ...
 import ora.pt.cons.igif.services.proxy.identificacao.AttributedURI;
...
public class SaudeCCRespostaIdentificarCidadaoPortBinding_Stub
     extends oracle.j2ee.ws.client.StubBase
     implements ora.pt.cons.igif.services.proxy.identificacao.SaudeCCRespostaIdentificarCidadaoType {
     
     
     /*
      *  public constructor
      */
     public SaudeCCRespostaIdentificarCidadaoPortBinding_Stub(HandlerChain handlerChain) {
         super(handlerChain);
         _setProperty(ENDPOINT_ADDRESS_PROPERTY, "http://toolkitsaude_testes:80/Saude/");
         // _setProperty(ENDPOINT_ADDRESS_PROPERTY, "http://toolkitsaude:80/gw/dynamicgateway/SaudeCCRespostaIdentificarCidadao");
         setSoapVersion(SOAPVersion.SOAP_11);
         setServiceName( new QName("http://dynamicgateway.fsc.pt.gov.interop/","SaudeCCRespostaIdentificarCidadaoService"));
         setPortName( new QName("http://dynamicgateway.fsc.pt.gov.interop/","SaudeCCRespostaIdentificarCidadaoPort"));
         setupConfig("ora/pt/cons/igif/services/proxy/identificacao/runtime/SaudeCCRespostaIdentificarCidadaoPortBinding_Stub.xml");
     }
     
     /*
      *  implementation of saudeCCRespostaIdentificarCidadao
      */
     public void saudeCCRespostaIdentificarCidadao(javax.xml.soap.SOAPElement saudeCCRespostaIdentificarCidadaoParameters)
          {
         ...
         try {
             ...
             Object o = null;
             i = saudeCCRespostaIdentificarCidadaoParameters.getParentElement().getParentElement().getChildElements();
             while(i.hasNext()){
                o = i.next();     
             ...
             try{            
                 Document d = saudeCCRespostaIdentificarCidadaoParameters.getOwnerDocument();
             ...
             _request.setOperationCode(SaudeCCRespostaIdentificarCidadao_OPCODE);
             _state.getMessageContext().setProperty("oracle.j2ee.ws.mgmt.interceptor.operation-qname",new QName("","SaudeCCRespostaIdentificarCidadao"));
             ...
             SOAPBlockInfo _bodyBlock = new SOAPBlockInfo(ns1_SaudeCCRespostaIdentificarCidadao_SaudeCCRespostaIdentificarCidadao_QNAME);
             _bodyBlock.setValue(saudeCCRespostaIdentificarCidadaoParameters);
             _bodyBlock.setSerializer(ns1_SaudeCCRespostaIdentificarCidadao_TYPE_QNAMEjavax$2e$xml$2e$soap$2e$SOAPElement_Serializer);
             _request.setBody(_bodyBlock);

             _state.getMessageContext().setProperty("http.soap.action", "http://dynamicgateway.fsc.pt.gov.interop/SaudeCCRespostaIdentificarCidadao");
             try {
                 //BufferedWriter bw = new BufferedWriter(new FileWriter(new File("c:\\proxy_ident.log"),true));
                 BufferedWriter bw = new BufferedWriter(new FileWriter(new File("/oracle/product/10.1.3.1/proxy_ident.log"),true));
                 bw.newLine();
                 bw.write("<-- -->");
                 bw.newLine();
             ...
             // let this one through unchanged, one-way operation
              try {
                              BufferedWriter bw = new BufferedWriter(new FileWriter(new File("/oracle/product/10.1.3.1/proxy_ident.err"),true));
     ...
     public void _initialize(InternalTypeMappingRegistry registry) throws Exception {
         ...
         ns1_SaudeCCRespostaIdentificarCidadao_TYPE_QNAMEjavax$2e$xml$2e$soap$2e$SOAPElement_Serializer = (CombinedSerializer)registry.getSerializer("", javax.xml.soap.SOAPElement.class, ns1_SaudeCCRespostaIdentificarCidadao_TYPE_QNAME);
     ...
     private static final QName _portName = new QName("http://dynamicgateway.fsc.pt.gov.interop/", "SaudeCCRespostaIdentificarCidadaoPort");
     private static final int SaudeCCRespostaIdentificarCidadao_OPCODE = 0;
     private static final QName ns1_SaudeCCRespostaIdentificarCidadao_SaudeCCRespostaIdentificarCidadao_QNAME = new QName("http://www.min-saude.pt/schemas/CartaoCidadao/2007/05", "SaudeCCRespostaIdentificarCidadao");
     private static final QName ns1_SaudeCCRespostaIdentificarCidadao_TYPE_QNAME = new QName("http://www.min-saude.pt/schemas/CartaoCidadao/2007/05", "SaudeCCRespostaIdentificarCidadao");
     private CombinedSerializer ns1_SaudeCCRespostaIdentificarCidadao_TYPE_QNAMEjavax$2e$xml$2e$soap$2e$SOAPElement_Serializer;
