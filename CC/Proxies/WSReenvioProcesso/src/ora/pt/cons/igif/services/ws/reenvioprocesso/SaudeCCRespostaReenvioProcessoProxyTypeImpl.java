package ora.pt.cons.igif.services.ws.reenvioprocesso;
...
import ora.pt.cons.igif.services.proxy.reenvioprocesso.SaudeCCRespostaReenvioProcessoPortClient;
...
public class SaudeCCRespostaReenvioProcessoProxyTypeImpl {
    public SOAPElement saudeCCRespostaReenvioProcessoProxy(SOAPElement saudeCCRespostaReenvioProcessoProxyParameters) {
        SaudeCCRespostaReenvioProcessoPortClient proxy = null;
        ...
        try{
            ...
            Object o = null;
            i = saudeCCRespostaReenvioProcessoProxyParameters.getParentElement().getParentElement().getChildElements();
            while(i.hasNext()){
                o = i.next();     
            ...
            Document d = saudeCCRespostaReenvioProcessoProxyParameters.getOwnerDocument();
            
            StringWriter stringWriter = new StringWriter();
            ((XMLElement) d.getDocumentElement()).print(stringWriter);            
            String s = stringWriter.toString();
            
            bw = new BufferedWriter(new FileWriter(new File("/oracle/product/10.1.3.1/reenviowsa.log"),true));
         ...
         //   }
            ...
            ///// FIM
            s = s.replaceAll("SaudeCCRespostaReenvioProcessoProxy","SaudeCCRespostaReenvioProcesso");
            //System.out.println(s);
            s = s.substring(s.indexOf("<SaudeCCRespostaReenvioProcesso"),s.indexOf("</SaudeCCRespostaReenvioProcesso>") + "</SaudeCCRespostaReenvioProcesso>".length());
            //s = s.substring(s.indexOf("<cc:SaudeCCRespostaReenvioProcesso"),s.indexOf("</cc:SaudeCCRespostaReenvioProcesso>") + "</cc:SaudeCCRespostaReenvioProcesso>".length());
            ...
            proxy = new SaudeCCRespostaReenvioProcessoPortClient();
            proxy.saudeCCRespostaReenvioProcesso(ss);
            retValString = "OK";
