...
// ---------------------------------------------------------------------
public class ListaUtentesDupRowImpl extends ViewRowImpl {
    public static final int IDPAI = 0;
    public static final int IIUDUPID = 1;
    public static final int IINID = 2;
    public static final int NOMECOMPLETO = 3;
    public static final int NISS = 4;
    public static final int NIR = 5;
    public static final int NOMESPROPRIOS = 6;
    public static final int APELIDOS = 7;
    public static final int NOP = 8;
    public static final int DTANASC = 9;
    public static final int NUMID = 10;
    ...
    public static final int NUMBENEF = 25;
    public static final int IHEID = 26;
    public static final int ENTRESPDESIG = 27;
    public static final int CSAUDEID = 28;
    public static final int TABINSCR = 29;

    /**This is the default constructor (do not remove)
     */
    public ListaUtentesDupRowImpl() {
    }

    /**Gets the attribute value for the calculated attribute IdPai
     */
    public Number getIdPai() {
        return (Number) getAttributeInternal(IDPAI);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute IdPai
     */
    public void setIdPai(Number value) {
        setAttributeInternal(IDPAI, value);
    }

    /**Gets the attribute value for the calculated attribute IiuDupId
     */
    public Number getIiuDupId() {
        return (Number) getAttributeInternal(IIUDUPID);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute IiuDupId
     */
    public void setIiuDupId(Number value) {
        setAttributeInternal(IIUDUPID, value);
    }
