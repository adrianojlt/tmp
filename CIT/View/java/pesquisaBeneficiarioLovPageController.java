...
public class pesquisaBeneficiarioLovPageController  extends PageController {
    ...
    public void prepareModel(LifecycleContext context) {    
        ...
        Misc.addMessage(context, "1", "Na seleção do parentesco deverá ser sempre considerado o grau de parentesco do familiar doente em relação ao beneficiário. ", "", Misc.MSG_TYPE_WARNG);
