...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt">
    <head>
        <title>Registo Nacional do Utente</title>
    ...
    <div><a id="redirectLink" class="headerLink" href="<%=request.getContextPath()%>/pub/index.do"></a></div>
            ...
            <table class="topHeaderTable" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <td class="topHeaderTableMiddleCol">
                        <span class="headerTitle">- Registo Nacional do Utente -</span>
                    </td>
